...
function Navbar() {
  ...
  return (
    <div
      ...
      <Box component="div" sx={{ display: "flex", alignItems: "center", marginRight: "auto" }}>
        <Avatar
          component="div"
        ...
        />
        <Divider orientation="vertical" flexItem sx={{ backgroundColor: "rgba(255, 255, 255, 0.4)" }}></Divider>
